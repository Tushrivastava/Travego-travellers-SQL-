...
-- e. What are the passenger names and the ticket price for those who traveled 1000 KMs Sitting in a bus? 
...
SELECT * FROM Passenger;
SELECT * FROM Price;
SELECT P.Passenger_name,P.Distance,PR.Bus_Type,PR.Price
FROM Passenger P,PRICE PR 
where
P.Distance=PR.Distance  and  P.passenger_name='pallavi';
